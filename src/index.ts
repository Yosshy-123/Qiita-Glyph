...
function postsIconSvg() {
  return `
    <g transform="scale(0.04) translate(0,0)">
      <g>
        <path style="fill:currentColor;" d="M333.314,0H81.464C68.464,0,57.891,10.568,57.891,23.573V81.39H28.939
        ...
        <path style="fill:currentColor;" d="M303.557,69.707H115.001c-4.504,0-8.159,3.655-8.159,8.159c0,4.504,3.655,8.159,8.159,8.159
          h188.556c4.509,0,8.159-3.655,8.159-8.159C311.716,73.362,308.066,69.707,303.557,69.707z"/>
        <path style="fill:currentColor;" d="M303.557,113.22H115.001c-4.504,0-8.159,3.655-8.159,8.159s3.655,8.159,8.159,8.159h188.556
          c4.509,0,8.159-3.655,8.159-8.159S308.066,113.22,303.557,113.22z"/>
        <path style="fill:currentColor;" d="M303.557,156.732H115.001c-4.504,0-8.159,3.655-8.159,8.159s3.655,8.159,8.159,8.159h188.556
          c4.509,0,8.159-3.655,8.159-8.159S308.066,156.732,303.557,156.732z"/>
        <path style="fill:currentColor;" d="M303.557,200.245H115.001c-4.504,0-8.159,3.655-8.159,8.159s3.655,8.159,8.159,8.159h188.556
          c4.509,0,8.159-3.655,8.159-8.159S308.066,200.245,303.557,200.245z"/>
        <path style="fill:currentColor;" d="M303.557,243.757H115.001c-4.504,0-8.159,3.655-8.159,8.159c0,4.504,3.655,8.159,8.159,8.159
          h188.556c4.509,0,8.159-3.655,8.159-8.159C311.716,247.412,308.066,243.757,303.557,243.757z"/>
        <path style="fill:currentColor;" d="M303.557,287.27H115.001c-4.504,0-8.159,3.655-8.159,8.159c0,4.504,3.655,8.159,8.159,8.159
...
function userIconSvg() {
  return `
    <!-- "User Heart Alt 1" by Dazzle UI, https://www.svgrepo.com/svg/532372/user-heart-alt-1 (CC Attribution) -->
