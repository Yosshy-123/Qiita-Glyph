...
function heartIconSvg() {
  return `
    <g transform="scale(0.75) translate(0,0)">
      <path 
        d="M14.115 28.184C15.103 29.096 16.896 29.109 17.884 28.21C24.741 21.962 29.176 17.92 28.995 12.883C28.917 10.667 27.786 8.542 25.954 7.291C23.166 5.374 19.845 5.928 17.472 7.644C16.925 8.04 16.428 8.497 16 9C15.572 8.497 15.074 8.04 14.527 7.645C12.153 5.932 8.833 5.385 6.045 7.291C4.213 8.542 3.083 10.667 3.005 12.883C2.836 17.94 7.293 21.993 14.115 28.184Z" 
        fill="currentColor"
      />
    </g>
  `;
...
function bookmarkIconSvg() {
  return `
    <!-- Stocks Icon: simplified fill for small card, natural thickness -->
    <g transform="scale(0.75) translate(0,0)">
      <path 
        d="M6.586 9.586C6.961 9.211 7.470 9 8 9H24C24.530 9 25.039 9.211 25.414 9.586C25.789 9.961 26 10.470 26 11V19C26 21.387 25.052 23.676 23.364 25.364C21.676 27.052 19.387 28 17 28H15C12.613 28 10.324 27.052 8.636 25.364C6.948 23.676 6 21.387 6 19V11C6 10.470 6.211 9.961 6.586 9.586Z" 
        fill="currentColor"
      />
    </g>
  `;
